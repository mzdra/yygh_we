<template>
  ...
  <div class="nav-container page-component" v-if="hospital.logoData != null">
    ...
    <div class="nav left-nav">
      <div class="nav-item">
        ...
        <!-- <span>
        <router-link :to="'/hosp/' + hospital.hoscode">
            查看
          </router-link>
          </span>
        <span class="v-link clickable dark" :onclick="
         'javascript:window.location=\'/hosp/' + hospital.hoscode + '\'' " >预约挂号 </span > -->
      </div>

      <div class="nav-item selected">
        <span class="v-link selected dark" >
          <router-link :to="'/hosp/detail/' + hospital.hoscode" style="text-decoration:none;color:rgb(68,144,241)">
           医院详情
          </router-link>
          </span>
        <!-- <span
...
export default {
  ...
  methods: {
    init() {
      hospitalApi.findHospDetail(this.hoscode).then((response) => {
