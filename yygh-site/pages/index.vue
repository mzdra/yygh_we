<template>
  <div class="home page-component">
    <el-carousel indicator-position="initial">
        ...
        <div class="suspend-notice-list space">
          ...
          <div class="content-wrapper">
            <div class="notice-wrapper">
              <div class="point"></div>
              <span class="notice v-link clickable dark">
                中国人民解放军总医院第六医学中心(原海军总医院)呼吸内科门诊停诊公告 </span
              >
            </div>
            ...
            <div class="notice-wrapper">
              <div class="point"></div>
              <span class="notice v-link clickable dark">
                首都医科大学附属北京潞河医院老年医学科门诊停诊公告 </span
              >
            </div>
...
export default {
  asyncData({ params, error }) {
    return hospApi.findHospList(1, 10, null).then((response) => {
      return {
  ...
  methods: {
    ...
    // 查询医院列表
    getHospList() {
      hospApi.findHospList(this.page, 10, this.searchObj).then((response) => {
